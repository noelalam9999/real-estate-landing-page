...
class Slider extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <div id="welcome_wrapper" className="fullscreen-container" data-alias="goodnews-header" data-source="gallery" style={{ background: '#eeeeee', padding: 0 }}>
                        <div id="welcome" className="  rev_slider  fullscreenbanner" style={{ display: 'none' }} data-version="5.4.3.1">
                            <ul>
                             
                                <li data-index="rs-904" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop={0} data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb={require('./../../images/main-slider/slider1/slide4.jpg').default} data-rotate={0} data-fstransition="fade" data-fsmasterspeed={300} data-fsslotamount={7} data-saveperformance="off" data-title data-param1 data-param2 data-param3 data-param4 data-param5 data-param6 data-param7 data-param8 data-param9 data-param10 data-description>
                                    {/* MAIN IMAGE */}
                                    <img src={require('./../../images/main-slider/slider1/slide4.jpg').default} alt="" data-lazyload={require('./../../images/main-slider/slider1/slide4.jpg').default} data-bgposition="center center" data-bgfit="cover" data-bgparallax={4} className="rev-slidebg" data-no-retina />
                          ...
                          {&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1000,&quot;to&quot;:&quot;opacity:0;&quot;,&quot;ease&quot;:&quot;Power4.easeOut&quot;}
                              ...
                              data-paddingleft="[0,0,0,0]" style={{ zIndex: 7, whiteSpace: 'nowrap', fontSize: 20, lineHeight: 0, fontWeight: 400, color: '#ffffff', letterSpacing: 0 }}>
                                      ...
                                      style={{ zIndex: 8, width: '100%' }}>
                                          ...
                                          data-paddingleft="[5,5,5,5]" 
                                          style={{ zIndex: 11, whiteSpace: 'normal', fontWeight: 600, color: '#fff', letterSpacing: 2, display: 'inline-block', textDecoration: 'none', textTransform: 'capitalize' }}>Message from Board of Directors</div>
                                                {/* LAYER NR. 6 */}
